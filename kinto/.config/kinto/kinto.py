...
# Fix for avoidin-g modmapping when using Synergy keyboard/mouse sharing.
...
define_keymap(re.compile(codeStr, re.IGNORECASE),{
    ...
    # Fix navigate back/forward
    # K("Super-minus"): debug_keys("superminus"), # kbd("ctrl-minus")
    K("Super-minus"): K("Alt-Ctrl-minus"),
    # K("Super-Shift-minus"): debug_keys("ctrlshiftminus"), kbd("ctrl-shift-minus")
    K("Super-Shift-minus"): K("Ctrl-Shift-minus"),
}, "Code")
...
# Globally make Caps Lock be ESC
define_keymap(None, {
    K("CAPSLOCK"): K("ESC"),
}, "Capslock is escape")
